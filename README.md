...
As we created the application, we learned React, Django, and the use of RESTful API at the spot. Not only did we learn how to intergrate front end and back end with the Kitsuo API data but also did we learn how to design a website using UI packages.
